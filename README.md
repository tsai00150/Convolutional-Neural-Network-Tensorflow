...
Tensorflow是一個由Google旗下的團隊「Google Brain Team」所開發的開放原始碼軟體資料庫，於2015年11月釋出初始版本，隨後被50個開發團隊採用，廣用於製作Google與相關的商業產品的機器學習工具，便取代了Google在2010年開始使用的第一代機器學習系統「DistBelief」的深度學習任務，成為很多我們日常生活中習以為常的服務功能，例如Gmail過濾垃圾信、Google翻譯、Google搜尋、Google語音搜尋、Google語音辨識、Google圖片辨識、Google相簿、Google地圖、Google街景、YouTube和網頁廣告投放......等等。\
